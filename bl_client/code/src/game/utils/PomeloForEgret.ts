 ...
 * @Last Modified time: 2018-11-08 14:28:07
...
module PomeloForEgret {
    export class Pomelo {
        ...
        private initWebSocket(host, port, cb: Function): void {
            LogUtils.logD("[Pomelo] connect to:", host, port);
            ...
            let url = ServerConfig.PATH_CONFIG.socket_header + host + ":" + port;
        ...
        private onClose(e: egret.Event): void {
            ...
            EventManager.instance.dispatch(Pomelo.EVEMT_DISCONNECT, e);
            if (this.socket) {
        ...
        private onIOError(e: egret.Event): void {
            ...
            EventManager.instance.dispatch(Pomelo.EVENT_IO_ERROR, e);
