 ...
 * @Last Modified time: 2018-08-23 18:51:40
 * @Description: 右家牌碰杠渲染赋值
 */

module majiang {
	export class MjRightPg extends eui.Component {
		private times;//那堆牌。
		private type;
		public color;
		private pbg;
		...
		private rightRectGroup: eui.Rect;
		...
		public createChildren() {
			...
			this.rightRectGroup.visible = false;
			switch (this.times) {
				case 1:
		...
		public showType(type, time) {
			switch (this.type) {
				...
				case 2:
				case 4:
					this.p_1.source = "right_angang_" + time + "_png";
					this.p_2.source = "right_angang_" + (time + 1) + "_png";
					this.p_3.source = "right_angang_" + (time + 2) + "_png";
					this.showColor_a();
					break;
			}
		}
		...
		public showRect(value) {
			if (value == 0) {
				...
				this.rightRectGroup.visible = true;
			}
		}
